...
{
    [Area("Admin")]
    [Authorize(Roles = "Admin, NhanVien, Passenger, Brand")]
    public class HomeController : Controller
    {
        ...
        public HomeController(ApplicationDbContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IHubContext<ChatHub> hubContext)
        {
            _context = context;
